 ...
 * git https://git.oschina.net/fedkey/UEditor-KityFormula-for-wordpress
 */
...
if ( class_exists( "UEditor" ) ) {
    ...
    $ue = new UEditor("postdivrich",array(
        ...
        "toolbars"=>array(
            ...
            'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'blockquote', 'pasteplain', '|','forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall','map', 'gmap', 'insertframe',),
            ...
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|', 'searchreplace', 'drafts', 'help','kityformula')
        )
        ,'lang'=>$ueditor_lang
        ,"focus"=>true
        ,"textarea"=>"content"
